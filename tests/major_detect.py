...
LastEditors: Ne0tea
LastEditTime: 2025-02-13 13:17:57
'''
'''
...
import sys
import time
from tree_top_parse.filter_length import find_outlength
from tree_top_parse.Inconsistant_toplogy_identify import decide_toplogy_from_process
...
def main(tree_file:str,sup_value:int, rootnested,target_name=None,test_mode:bool=False):
    ...
    print(gene_tree.write(is_leaf_fn=collapsed_leaf))
...
if __name__ == "__main__":
    # tree_file=r'E:\Bio_analysis\HGT_newcollection\HGTfinder_script\Downstream_subscript_V2_0911\GF_14_sg_prot.contree'
    tree_file=r'E:\Bio_analysis\HGT_newcollection\HGTfinder_script\AGFD.0.1.0\tests\gene_tree_5924.pruned_modified.tree'
    sup_value=50
    # config=r'E:\Bio_analysis\HGT_newcollection\2_HGTfinder_workpath\Poaceae_config.txt'
    config=r'E:\Bio_analysis\HGT_newcollection\HGTfinder_script\AGFD.0.1.0\tests\config_22.txt'
    pb.main(config)
    clade_subg_dic=glv.get('clade_subg_dic')
