...
LastEditors: Ne0tea
LastEditTime: 2024-09-12 11:12:18
'''
import re
import sys
import os
...
clade_asm_dic=config_read.read_phy_order(r'E:\Bio_analysis\HGT_newcollection\2_HGTfinder_workpath\Poaceae_config.txt')
###亚科颜色列表
phy_col={"BAM":"#b71515","ORY":"#e97a0c","POO":"#ffde0a","PAN":"#023e7d","CHL":"#a3cef1","OUT":"#a9a29c"}
...
def define_sub(gene):
    sp=gene.split("_")[0]
    if sp in clade_asm_dic['BAM']:
        return "BAM"
    elif sp in clade_asm_dic['ORY']:
        return "ORY"
    elif sp in clade_asm_dic['POO']:
        return "POO"
    elif sp in clade_asm_dic['PAN']:
        return "PAN"
    elif sp in clade_asm_dic['CHL']:
        return "CHL"
    elif sp in clade_asm_dic['OUT']:
        return "OUT"
    else:
        return "empty"
